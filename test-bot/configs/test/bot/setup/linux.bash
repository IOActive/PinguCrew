...
function run_bot () {
  bot_index=0
  bot_directory=$INSTALL_DIRECTORY/clussterfuzz
  ...
  while true; do
    ...
    PATH="$PATH" NFS_ROOT="$NFS_ROOT" GOOGLE_APPLICATION_CREDENTIALS="$GOOGLE_APPLICATION_CREDENTIALS" ROOT_DIR="$bot_directory/clusterfuzz" PYTHONPATH="$PYTHONPATH" GSUTIL_PATH="$GSUTIL_PATH" BOT_NAME="linux-$(hostname)" HTTP_PORT_1="$((bot_index+8000))" HTTP_PORT_2="$((bot_index+8080))" python $bot_directory/fuzzBot/src/python/clussterfuzz/startup/run.py || true
