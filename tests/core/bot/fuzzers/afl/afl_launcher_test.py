...
class LauncherTestBase(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'clusterfuzz._internal.bot_working_directory.fuzzers.utils.get_temp_dir',
    ])
...
class AflRunnerTest(LauncherTestBase):
  ...
  def _initialization_for_run_afl(self):
    ...
    test_helpers.patch(self, [
        'clusterfuzz._internal.bot_working_directory.fuzzers.afl.launcher.AflRunner.run_and_wait',
    ])
