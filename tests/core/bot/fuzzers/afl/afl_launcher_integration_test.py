...
class BaseLauncherTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        ...
        'clusterfuzz._internal.bot_working_directory.fuzzers.afl.launcher.rand_cmplog_level',
        'clusterfuzz._internal.bot_working_directory.fuzzers.afl.launcher.rand_schedule'
    ])
  ...
  def _test_libfuzzerize_corpus(self, mock_get_timeout):
    ...
    test_helpers.patch(self, [
        'clusterfuzz._internal.bot_working_directory.fuzzers.afl.launcher.AflRunnerCommon.fuzz',
        'clusterfuzz._internal.bot_working_directory.fuzzers.afl.launcher.AflFuzzOutputDirectory.is_testcase'
    ])
